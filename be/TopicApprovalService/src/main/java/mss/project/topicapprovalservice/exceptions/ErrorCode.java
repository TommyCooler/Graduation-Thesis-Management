...
public enum ErrorCode {
    ...
    STATUS_OF_PREVIOS_COUNCIL_NOT_VALID(814, "Trạng thái của mốc trước đó phải là Đã duyệt"),
    STATUS_OF_COUNCIL_IS_APPROVED(815,"Mốc review này đã được duyệt, không thể comment"),
    COMMENT_IS_NULL(816,"Các thành viên hội đồng phải comment đầy đủ trước khi cập nhật trạng thái"),
