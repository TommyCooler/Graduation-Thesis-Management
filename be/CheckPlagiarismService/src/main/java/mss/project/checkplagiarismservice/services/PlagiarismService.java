...
public interface PlagiarismService {
    ...
    /**
     * Process plagiarism report received from N8N and save to database
     *
     ...
     */
    List<PlagiarismResult> getPlagiarismResultsByTopicId(Long topicId);

    /**
     * Delete plagiarism results for a topic (used when updating topic)
     *
     * @param topicId the topic ID to delete results for
     */
    void deletePlagiarismResultsByTopicId(Long topicId);
}
